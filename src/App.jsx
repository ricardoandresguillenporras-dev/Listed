...
function AddItemsView({ list, sym, theme, onBack, onAddItem }) {
  ...
  const [userPickedEmoji, setUserPickedEmoji] = useState(false); // true once user manually selects an emoji
...
.wc-search-wrap .icon { position:absolute; left:13px; top:50%; transform:translateY(-50%); pointer-events:none; color:var(--textMuted); opacity:0.6; }
      ...
      <div style={Sd.app}>
        ...
        {view==="addItems" && activeList && (
          ...
          <AddItemsView list={activeList} sym={sym} theme={theme} onBack={handleAddBack} onAddItem={addItem} />
          </div>
        )}
      </div>
