      ...
      <div style={Sth.bottomBar}>
        <div style={{ position:"relative", flex:1 }}>
          ...
          <input value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Buscar en lista..."
            style={{ width:"100%", background: theme.isDark ? theme.inputBg : theme.inputBg, border: theme.isDark ? `2px solid ${theme.inputBorder}` : `2px solid ${theme.inputBorder||theme.border||"#C8DC90"}`, borderRadius:22, padding:"9px 16px 9px 36px", color:"var(--textPrimary)", fontSize:14, outline:"none", boxSizing:"border-box" }} />
        </div>
      </div>
