...
const makeStyles = (theme) => ({
  ...
  body: {
    ...
    overscrollBehavior: "contain",       // prevent scroll chain leaking to parent
  },
  bottomBar: {
...
.wc-search-wrap .icon { position:absolute; left:13px; top:50%; transform:translateY(-50%); pointer-events:none; color:var(--textMuted); opacity:0.6; }
      ...
      <div style={Sd.app}>
        ...
        {view==="stats" && (
          <div key="stats" className={navDir === "back" ? "view-enter-back" : "view-enter-fwd"} onAnimationEnd={clearViewAnim} style={{ paddingBottom:80 }}
