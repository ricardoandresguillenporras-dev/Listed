...
export default function SuperLista() {
  ...
  useEffect(() => {
    ...
    if (targetDepth > currentDepth) {
      ...
      // Programmatic back (chevron button) — just update our ref.
      // The actual history entries were already consumed by the chevron handler.
      historyDepthRef.current = targetDepth;
      // Ensure we always have at least depth=1 in the stack
      if (targetDepth <= 1) {
        window.history.replaceState({ slDepth: 1 }, "");
