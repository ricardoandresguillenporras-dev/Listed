...
.view-enter-fwd  { animation: viewEnterFwd  0.28s var(--ease-out) both; will-change: transform, opacity; }
.view-enter-back { animation: viewEnterBack 0.28s var(--ease-out) both; will-change: transform, opacity; }
...
.wc-fab-glow {
  ...
  animation: slFabGlow 3s ease-in-out infinite;
  will-change: opacity;
}
@keyframes slFabGlow {
  0%,100% { opacity:0; }
...
/* ── Glass card effect ───────────────────────────────────────────────── */
.wc-card, .list-card {
  animation: cardIn 0.38s var(--ease-spring) both;
}
